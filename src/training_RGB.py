...
# Preprocess the data
images, labels = preprocess_data(spreadsheet, DIR, num_records=5200, target_size=(448, 448))
# Encode labels
...
def build_model(input_shape=(448, 448, 3), num_classes=3):  # Change num_classes to 3
...
checkpoint = ModelCheckpoint('best_pneumonia_modelrgb.keras', save_best_only=True, monitor='val_accuracy')
...
# Load the best model
best_model = tf.keras.models.load_model('best_pneumonia_modelrgb.keras')
